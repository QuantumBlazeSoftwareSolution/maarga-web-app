...
const nmOuter =
  '6px 6px 14px #c0c3c8, -6px -6px 14px #ffffff';
const nmPressed =
  'inset 4px 4px 10px #c0c3c8, inset -4px -4px 10px #ffffff';
const nmSubtle =
  '3px 3px 8px #c0c3c8, -3px -3px 8px #ffffff';
...
function NmCard({ children, className = '', pressed = false, onClick }: NmCardProps) {
  return (
    <div
      onClick={onClick}
      style={{ boxShadow: pressed ? nmPressed : nmOuter, background: '#E1E4E9' }}
...
function NmButton({ children, onClick, className = '', variant = 'raised' }: {
  children: React.ReactNode;
  onClick?: () => void;
  className?: string;
  ...
  return (
    <button
      onClick={onClick}
      style={{ boxShadow: variant === 'pressed' ? nmPressed : nmSubtle, background: '#E1E4E9' }}
...
export default function AdminDashboard() {
  ...
  const analyticsItems = [
    { label: 'Station Records', sub: '452 stations · 18 items', icon: '📍', kwh: '452 total' },
    { label: 'API Requests', sub: 'v1 endpoints · last 24h', icon: '⚡', kwh: '12.4k req' },
    { label: 'Admin Sessions', sub: '3 active · secured', icon: '🔐', kwh: '3 active' },
    { label: 'System Uptime', sub: 'All services nominal', icon: '✅', kwh: '99.9%' },
  ];
    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-bold tracking-tight text-slate-700">Maarga Admin</span>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <NmCard className="flex items-center gap-3 px-4 py-2">
            ...
            <div>
              <p className="text-xs font-bold text-slate-700 leading-none">Admin Account</p>
              <p className="text-[10px] text-slate-400 leading-tight mt-0.5">System Overseer</p>
            </div>
            <button
      ...
      <main className="mx-auto max-w-6xl px-8 pb-12 pt-2">
        ...
        <div className="mb-6 flex items-start justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500 font-medium">Maarga Platform · All services operational</p>
          </div>
          {/* Live indicator */}
          <div
            style={{ boxShadow: nmSubtle, background: '#E1E4E9' }}
          ...
          >
            <span className="h-2 w-2 animate-pulse rounded-full bg-emerald-400" style={{ boxShadow: '0 0 6px rgba(52,211,153,0.8)' }}></span>
            ...
            <NmCard className="p-6">
              <div className="mb-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-sm font-bold text-slate-700">System Performance</h2>
                    <p className="text-xs text-slate-400">Real-time load monitoring</p>
                  </div>
                </div>
                ...
                >
                  ...
                  <span className="text-[10px] font-bold text-slate-600 uppercase tracking-wider">Nominal</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-center gap-12">
                <div className="relative flex items-center justify-center">
                  <svg width="200" height="200" viewBox="0 0 200 200">
                    ...
                    {/* Center value */}
                    <text x="100" y="96" textAnchor="middle" className="font-black" style={{ fontFamily: 'Inter, sans-serif', fontSize: '32px', fontWeight: '900', fill: '#1e293b' }}>{loadValue}</text>
                    <text x="100" y="116" textAnchor="middle" style={{ fontFamily: 'Inter, sans-serif', fontSize: '11px', fontWeight: '600', fill: '#6b7280', letterSpacing: '0.05em', textTransform: 'uppercase' }}>Load %</text>
                    {/* Min/Max labels */}
                    <text x="30" y="168" textAnchor="middle" style={{ fontFamily: 'Inter, sans-serif', fontSize: '10px', fill: '#9ca3af' }}>0%</text>
                    <text x="170" y="168" textAnchor="middle" style={{ fontFamily: 'Inter, sans-serif', fontSize: '10px', fill: '#9ca3af' }}>100%</text>
                  </svg>
                </div>
                ...
                <div className="flex flex-col gap-4">
                  {[
                    ...
                    { label: 'DB Queries', value: '1.2k/s', color: 'bg-purple-400' },
                  ].map((s) => (
                    <div key={s.label} className="flex items-center gap-4">
                      ...
                      >
                        <div
                          ...
                          style={{ width: s.value.includes('%') ? s.value : '60%', opacity: 0.85 }}
                        />
                      </div>
                      <span className="w-12 text-xs font-bold text-slate-600">{s.value}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              >
                <div className="mb-4 flex items-start justify-between">
                  ...
                  <div
                    style={{ boxShadow: nmSubtle, background: '#E1E4E9' }}
                    className="flex h-7 w-7 items-center justify-center rounded-lg text-slate-400 hover:text-slate-700 transition-colors"
                  >
                    <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <h3 className="text-base font-bold text-slate-700">Station Manager</h3>
                <p className="mt-1 text-xs font-medium text-slate-400">452 stations active</p>
            ...
            <NmCard className="px-6 py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs font-bold text-slate-700">Platform records synced</p>
                    <p className="text-xs text-slate-400">452 stations · 18 item types in use</p>
                  </div>
                </div>
                <NmButton
                  onClick={() => router.push('/developer-back-door/dashboard/station-import')}
            ...
            <NmCard className="p-5">
              <div className="flex items-center gap-3">
                <div
                  ...
                  style={{ background: 'linear-gradient(135deg, #3B82F6, #6366F1)', boxShadow: '3px 3px 6px #c0c3c8, -3px -3px 6px #ffffff' }}
                >
                  AA
                </div>
            ...
            <NmCard className="flex-1 p-5">
              <div className="mb-4 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h3 className="text-xs font-bold text-slate-700">Platform Analytics</h3>
                    <p className="text-[10px] text-slate-400">Live overview</p>
                  </div>
                </div>
                <div
                  style={{ boxShadow: nmSubtle, background: '#E1E4E9' }}
                  className="flex h-7 w-7 items-center justify-center rounded-lg text-slate-400 hover:text-blue-500 transition-colors cursor-pointer"
                >
                ...
                {analyticsItems.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <span className="text-[10px] font-black text-slate-500">{item.kwh}</span>
                      <div
                        style={{ boxShadow: nmSubtle, background: '#E1E4E9' }}
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <NmCard key={s.label} className="p-4">
                  ...
                  <p className="mt-1 text-xl font-black text-slate-700 leading-none">{s.value}</p>
                  <p className="mt-1 text-[10px] font-bold text-emerald-500">{s.trend}</p>
                </NmCard>
              ))}
            </div>
          </div>
