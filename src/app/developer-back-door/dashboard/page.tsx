        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-white/5 bg-white/2 p-6 transition-all hover:bg-white/4">
            ...
            <p className="mb-6 text-sm text-white/40">
              Explore versioned Swagger specs and test endpoints directly from
              the interface.
            </p>
            <button
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-white/5 bg-white/2 p-6 transition-all hover:bg-white/4">
            ...
            <p className="mb-6 text-sm text-white/40">
              Use the secure POST endpoint to create new admin entities via
              centralized proxy.
            </p>
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-white/5 bg-white/2 p-6 transition-all">
            <div className="mb-4 flex items-center justify-between">
              ...
              <span className="text-[10px] tracking-widest text-emerald-500 uppercase">
                Online
              </span>
            </div>
            <h2 className="mb-2 text-lg font-light text-white/90">
            ...
            <p className="mb-1 flex justify-between text-sm text-white/40">
              <span>Environment:</span>
              <span className="text-white/60">Development</span>
            </p>
            <p className="flex justify-between text-sm text-white/40">
              <span>Database:</span>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-sm font-medium text-emerald-500">
                Developer Back-Door Status
              </h3>
              <p className="mt-1 text-xs leading-relaxed text-white/40">
                You are currently logged into the restricted developer console.
                This environment bypasses standard user authentication to allow
                for rapid infrastructure management. Remember to audit the{' '}
                <code className="text-emerald-500/80">X-API-KEY</code> rotation
                regularly.
              </p>
            </div>
          </div>
